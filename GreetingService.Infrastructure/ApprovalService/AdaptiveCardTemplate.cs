            ...
            var jsonFile = @$"{{
						...
						""sections"": [
							{{
								...
								""activityImage"": ""https://eur.delve.office.com/?u=acacf547-6bdb-41f8-b6b8-dac5cb97e49f&v=work"",
							...
							{{
								""potentialAction"": [
									{{
										""@type"": ""HttpPOST"",
										""name"": ""Approve"",
										""target"": ""https://towafunctionapp.azurewebsites.net/api/user/approve/{user.ApprovalCode}""
	
									}},
									{{
										""@type"": ""HttpPOST"",
										""name"": ""Reject"",
										""target"": ""https://towafunctionapp.azurewebsites.net/api/user/reject/{user.ApprovalCode}""
									}}
								]
							}}
						]
